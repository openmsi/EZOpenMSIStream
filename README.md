...
To build a docker image, the Dockerfile will first import the official openmsistream image. Then, it will move the necessary Kafka config file and startup-script.sh to the docker container. <br>
Then, one can then: 
